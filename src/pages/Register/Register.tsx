    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full mx-auto bg-white p-8 rounded-2xl shadow-md border border-gray-100">
        ...
        <form onSubmit={handleSubmit(handleForm)} className="flex flex-col gap-4">
          <Input control={control} label="Nombre Completo" name="name" type="text" error={errors.name}/>
          <Input control={control} label="Correo Electrónico" name="email" type="email" error={errors.email}/>
          <Input control={control} label="Contraseña" name="password" type="password" error={errors.password}/>
          <Input control={control} label="Confirmar Contraseña" name="confirmPassword" type="password" error={errors.confirmPassword}/>
